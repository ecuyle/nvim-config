...
local mappings = {
	...
	f = {
		...
		f = { "<cmd>lua require('telescope.builtin').find_files({ path_display = { 'absolute' } })<cr>", "File" },
		h = { "<cmd>Telescope help_tags<cr>", "Help Tag" },
		k = { "<cmd>Telescope keymaps<cr>", "Keymap" },
		p = { "<cmd>Telescope projects<cr>", "Project" },
		r = { "<cmd>Telescope oldfiles<cr>", "Recent File" },
		t = { "<cmd>lua require('telescope.builtin').live_grep({ path_display = { 'absolute' } })<cr>", "Text" },
	},
	g = {
		name = "Git",
	...
	s = {
		name = "Sort",
		c = { "vi{:'<,'>sort<cr>", "Sort in curly brackets" },
		b = { "vi(:'<,'>sort<cr>", "Sort in parent brackets" },
		p = { "vip:'<,'>sort<cr>", "Sort in paragraph" },
